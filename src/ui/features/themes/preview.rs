...
use gpui::{div, px, Div, Entity, Hsla, IntoElement, ParentElement, SharedString, Styled};
...
use super::{
    lint_theme_config, resolve_theme_preference, ThemeCatalogEntry, ThemeLintItem,
    ThemeLintSeverity,
};
use crate::ui::persistence;
use crate::ui::state::WgApp;

pub(super) fn render_theme_preview_field(app: Entity<WgApp>, cx: &mut gpui::App) -> Div {
